...
weights = {
    'w1': tf.Variable(tf.random_normal([1, 250, 250, 1], stddev=1e-3), name='w1'),
    'w2': tf.Variable(tf.random_normal([9,9,1,64], stddev=1e-3), name='w2'),
    'w3': tf.Variable(tf.random_normal([1, 250, 250, 1], stddev=1e-3), name='w3')
}
print(weights)
...
"""
model_path = './sample_data/model.npy'
model = np.load(model_path,allow_pickle=True, encoding='latin1').item()
